...
return array(
	'ctrl' => array(
		'title'	=> 'LLL:EXT:doi_poll/Resources/Private/Language/locallang_db.xlf:tx_doipoll_domain_model_voting',
		'label' => 'active',
		'tstamp' => 'tstamp',
		'crdate' => 'crdate',
		'cruser_id' => 'cruser_id',
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_doipoll_domain_model_voting.pid=###CURRENT_PID### AND tx_doipoll_domain_model_voting.sys_language_uid IN (-1,0)',
			),
		),
		...
		'active' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:doi_poll/Resources/Private/Language/locallang_db.xlf:tx_doipoll_domain_model_voting.active',
			'config' => array(
				'type' => 'check',
				'default' => 0
			)
