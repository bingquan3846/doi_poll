...
/**
 * Test case for class ZerosOnes\DoiPoll\Controller\VotingController.
 *
...
class VotingControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \ZerosOnes\DoiPoll\Controller\VotingController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('ZerosOnes\\DoiPoll\\Controller\\VotingController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllVotingsFromRepositoryAndAssignsThemToView()
	{
		...
		$votingRepository = $this->getMock('', array('findAll'), array(), '', FALSE);
